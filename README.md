...
Desktop-class terminal for SailfishOS, powered by [Ghostty](https://github.com/ghostty-org/ghostty)'s VT engine. Truecolor, multi-session, TUI apps, encrypted scrollback.
...
- **5 color schemes**: Dark, Light, Solarized Dark/Light, Monokai, adjustable opacity
- **35+ translations**

## Architecture

Built with Qt/QML and Sailfish Silica. Terminal engine is Ghostty's `libghostty-vt` (Zig, static C library). Rendering via QPainter. Native cover page, single-instance via D-Bus. Built for aarch64, armv7hl, and i486.
